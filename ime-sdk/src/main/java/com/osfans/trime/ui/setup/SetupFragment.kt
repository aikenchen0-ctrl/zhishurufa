...
import com.osfans.trime.databinding.TrimeFragmentSetupBinding
import com.osfans.trime.util.serializable

class SetupFragment : Fragment() {
    private lateinit var binding: TrimeFragmentSetupBinding
    ...
    override fun onCreateView(
        ...
        binding = TrimeFragmentSetupBinding.inflate(inflater).apply {
