...
import com.osfans.trime.databinding.TrimeActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        delegate.localNightMode = uiMode
        ...
        enableEdgeToEdge()
        val binding = TrimeActivityMainBinding.inflate(layoutInflater)
        ...
        binding.draftPanelHost.addView(
            DraftPanelView(this, TrimeSdk.drafts, DraftSurface.HOST),
    ...
    companion object {
        const val EXTRA_SETTINGS_ROUTE = "com.osfans.trime.sdk.EXTRA_SETTINGS_ROUTE"
    }
}
