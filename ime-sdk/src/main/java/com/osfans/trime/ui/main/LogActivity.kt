...
import com.osfans.trime.databinding.TrimeActivityLogBinding
...
class LogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        val binding = TrimeActivityLogBinding.inflate(layoutInflater)
        ...
        with(binding) {
            ...
            if (intent.hasExtra(FROM_CRASH)) {
                ...
                logView.setLogcat(Logcat(TrimeSdk.lastPid))
