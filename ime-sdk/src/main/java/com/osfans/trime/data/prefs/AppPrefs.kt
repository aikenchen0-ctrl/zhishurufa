...
class AppPrefs(
    ...
    class Keyboard(
        ...
        val landscapeMode = enum(R.string.enable_landscape_mode, LANDSCAPE_MODE, LandscapeMode.LANDSCAPE)
    ...
    class Advanced(
        ...
        companion object {
            ...
            const val EDITOR_CONTEXT_ENABLED = "editor_context_enabled"
        }
        ...
        val editorContextEnabled = switch(
            R.string.editor_context_enabled,
            EDITOR_CONTEXT_ENABLED,
            false,
            R.string.editor_context_enabled_summary,
        )
    }
}
