...
val Project.librimeVersion: String
    get() = nativeVersion("librime")

val Project.openccVersion: String
    get() = nativeVersion("OpenCC")

val Project.nativeSourceDir: File
    get() = rootProject.file("app/src/main/jni")

private fun Project.nativeVersion(module: String): String = providers.exec {
    workingDir(nativeSourceDir.resolve(module))
    commandLine("git", "describe", "--tags", "--long", "--always", "--exclude=latest")
